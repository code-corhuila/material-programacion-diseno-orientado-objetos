...
topic: Clases, objetos y el modelo de referencias
eyebrow: Actividad opcional · Formativa · Entrega por GitHub
lead: Consolida el diseño de una clase, la creación de objetos con estado propio y —lo más sutil— el comportamiento de las referencias (aliasing). Actividad opcional de refuerzo.
objectives:
...
2. Coloca tu entrega en la carpeta **`02-week/`** correspondiente a esta semana.
3. Sube los cambios: `git add .` · `git commit -m "Entrega semana 02"` · `git push` (abre un *Pull Request* si el docente lo pide).
...
[⬇ Descargar la guía en PDF (membrete oficial CORHUILA)](pdf/Actividad-Semana02.pdf)
